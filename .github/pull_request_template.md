...
- [ ] Code follows project style (`ruff check`, 90-column lines, banner comments)
- [ ] Machine-generated `_UPPERCASE.py` tables regenerated with `ktupler.py`, not hand-edited
