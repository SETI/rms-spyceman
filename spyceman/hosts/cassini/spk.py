...
_SPK_SOURCE = 'https://naif.jpl.nasa.gov/pub/naif/CASSINI/kernels/spk'

if 'SPICEPATH-CASSINI-SPK' in os.environ:
    _SPK_DEST = os.environ['SPICEPATH']
elif 'SPICEPATH-CASSINI' in os.environ:
    _SPK_DEST = os.path.join(os.path.join(os.environ['SPICEPATH'], 'SPK')
elif 'SPICEPATH' in os.environ:
    _SPK_DEST = os.path.join(os.path.join(os.environ['SPICEPATH'], 'Cassini', 'SPK')
else
    _SPK_DEST = ''
